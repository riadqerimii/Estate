    ...
    <div>
      <div className="flex flex-col gap-6  pt-36 max-w-7xl mx-auto">
        <h1 className="text-slate-700 font-bold text-3xl lg:text-6xl">
          Find your next
          <span className="text-slate-500"> perfect place</span>
        </h1>
        <div className="text-gray-600 text-xs sm:text-sm pt-5 ">
          Real Estate ise the best place to find your next perfect place to
          live.
          <br />
      ...
      <Swiper navigation className="max-w-7xl mx-auto my-2">
        {offerListings &&
          offerListings.length > 0 &&
          offerListings.map((listing) => (
            <SwiperSlide
              className="p-1 bg-white  shadow-black overflow-hidden"
              key={listing._id}
            >
              <div
                style={{
